...
Now it will choose automatically between Lobby-1 and Lobby-2

To use it you only have to go into item command and add this rule: tasks= Lobby
You can add some options behind:
- LOWEST_PLAYERS: Will connect you on the server who have the lowest number of players
- HIGHEST_PLAYERS: Will connect you on the server who have the highest number of players
